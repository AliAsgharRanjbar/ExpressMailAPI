const SEND_HTML_TEMPLATE = (name, message) => {
...
return `
    ...
    <body style="background-color: #f6f6f6; font-family: Vazirmatn, sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
        <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">alibot.ir - Contact form Got your message!</span>
            ...
            <div class="content" style="box-sizing: border-box; display: block; margin: 0 auto; max-width: 580px; padding: 10px;">
                ...
                <tr>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                        ...
                        <td style="font-family: Vazirmatn, sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                            <h1 style="font-family: Vazirmatn, sans-serif; font-size: 26px; font-weight: 900; margin: 0; margin-bottom: 15px;">Hi dear <i>${name}</i></h1>
                            <p style="font-family: Vazirmatn, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Thanks for reaching out to me.&nbsp;I just received your <i> message </i> => <pre><i>“ ${message} ”</i><pre/></p>
                            <p style="font-family: Vazirmatn, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">I will respond to you ASAP.</p>
                            <p style="font-family: Vazirmatn, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Best regards.</p>
                            ...
                            <tbody>
                                ...
                                <td align="left" style="font-family: Vazirmatn, sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;" valign="top">
                                    ...
                                    <tbody>
                                        <tr>
                                        <td style="font-family: Vazirmatn, sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #3498db;" valign="top" align="center" bgcolor="#3498db"> <a href="http://alibot.ir"  style="border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #3498db; border-color: #3498db; color: #ffffff;">Visit my website</a> </td>
                                        </tr>
                                    </tbody>
                                    </table>
                                </td>
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    ...
                    <td class="content-block" style="font-family: Vazirmatn, sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #999999; font-size: 12px; text-align: center;" valign="top" align="center">
                        <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">This message has sent automatically due to your submission of contact form at <a href="https://alibot.ir">alibot.ir</a></span>
                    </td>
                    </tr>
                    <tr>
                    </td>
...
export default SEND_HTML_TEMPLATE;
